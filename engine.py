...
# Unified legal sportsbook anchors operating natively in Illinois and Florida + Bovada reference layer
...
def execute_global_pitch_sweeps():
    ...
    # -----------------------------------------------------------------
    # PIPELINE: Universal Grouping (The Odds API) targeting specific soccer events
    # -----------------------------------------------------------------
