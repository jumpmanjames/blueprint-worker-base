...
# =====================================================================
# CORE CONFIGURATION & ENVIRONMENT PARAMETERS
# =====================================================================
...
# Target competition stream keys covering major, low-tier, cup tournaments, and women's slates natively
TARGET_SPORT_KEYS = [
    "soccer_usa_major_league_soccer", "soccer_mexico_ligamx", "soccer_uefa_nations_league",
    "soccer_epl", "soccer_spain_la_liga", "soccer_italy_serie_a", "soccer_germany_bundesliga",
    "soccer_france_ligue_one", "soccer_spain_segunda_division", "soccer_netherlands_eredivisie",
    "soccer_portugal_primeira_liga", "soccer_brazil_campeonato", "soccer_argentina_primavera"
]
...
def parse_multi_market_odds(bookmaker_data):
    ...
    (Draws, Handicaps, Asian Handicaps, 1st-Half ML, Totals Over 1.5/2.5) 
...
def execute_global_pitch_sweeps():
    ...
    # -----------------------------------------------------------------
    # PIPELINE: Direct Sportsbook Forcing (The Odds API)
    # -----------------------------------------------------------------
    for sport_key in TARGET_SPORT_KEYS:
        ...
        try:
            ...
            print(f"[-] Processing exception skipped on {sport_key}: {e}")
...
if __name__ == "__main__":
    while True:
        ...
        time.sleep(600)  # Continuous background sweep interval set to 10 minutes
