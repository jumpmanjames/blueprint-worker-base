...
MASTER_BOOKIE_CATALOG = [
    ...
    {"key": "soccer_chile_campeonato", "title": "Chile Liga de Primera", "api_id": 265, "aliases": ["chile liga de primera", "primera division", "chile primera division", "campeonato nacional"]},
    {"key": "soccer_ecuador_serie_a", "title": "Ecuador LigaPro Serie A", "api_id": 242, "aliases": ["ecuador ligapro serie a", "ligapro serie a", "ecuador serie a"]},
    ...
    {"key": "soccer_england_championship", "title": "England Championship", "api_id": 40, "aliases": ["england championship", "championship", "efl championship"]},
    {"key": "soccer_england_league1", "title": "England League 1", "api_id": 41, "aliases": ["england league 1", "league one", "efl league one"]},
    {"key": "soccer_england_league2", "title": "England League 2", "api_id": 42, "aliases": ["england league 2", "league two", "efl league two"]},
    {"key": "soccer_england_efl_cup", "title": "England EFL Cup", "api_id": 48, "aliases": ["england efl cup", "efl cup", "league cup", "carabao cup"]},
    {"key": "soccer_scotland_premier", "title": "Scotland Premiership", "api_id": 179, "aliases": ["scotland premiership", "premiership", "scottish premiership"]},
    {"key": "soccer_scotland_championship", "title": "Scotland Championship", "api_id": 180, "aliases": ["scotland championship"]},
    {"key": "soccer_spain_la_liga", "title": "Spain La Liga", "api_id": 140, "aliases": ["spain la liga", "la liga", "laliga", "spain primera division"]},
    {"key": "soccer_spain_segunda_division", "title": "Spain Segunda", "api_id": 141, "aliases": ["spain segunda", "segunda division", "la liga 2"]},
    {"key": "soccer_italy_serie_a", "title": "Italy Serie A", "api_id": 135, "aliases": ["italy serie a", "serie a", "serie a tim"]},
    {"key": "soccer_italy_serie_b", "title": "Italy Serie B", "api_id": 136, "aliases": ["italy serie b", "serie b", "serie bkt"]},
    {"key": "soccer_germany_bundesliga", "title": "Germany Bundesliga I", "api_id": 78, "aliases": ["germany bundesliga i", "bundesliga", "german bundesliga"]},
    {"key": "soccer_germany_bundesliga2", "title": "Germany Bundesliga II", "api_id": 79, "aliases": ["germany bundesliga ii", "2. bundesliga", "2 bundesliga"]},
    {"key": "soccer_germany_3liga", "title": "Germany 3.Liga", "api_id": 80, "aliases": ["germany 3.liga", "3. liga", "3 liga"]},
    {"key": "soccer_france_ligue_one", "title": "France Ligue 1", "api_id": 61, "aliases": ["france ligue 1", "ligue 1", "french ligue 1"]},
    {"key": "soccer_france_ligue_two", "title": "France Ligue 2", "api_id": 62, "aliases": ["france ligue 2", "ligue 2", "french ligue 2"]},
    ...
    {"key": "soccer_portugal_primeira_liga", "title": "Portugal Primeira Liga", "api_id": 94, "aliases": ["portugal primeira liga", "primeira liga", "portuguese primeira liga"]},
    {"key": "soccer_austria_bundesliga", "title": "Austria Bundesliga", "api_id": 218, "aliases": ["austria bundesliga", "austrian bundesliga"]},
    {"key": "soccer_belgium_first_div", "title": "Belgium First Division A", "api_id": 144, "aliases": ["belgium first division a", "pro league", "belgian pro league"]},
    {"key": "soccer_bulgaria_first_league", "title": "Bulgaria First League", "api_id": 172, "aliases": ["bulgaria first league", "parva liga"]},
    {"key": "soccer_croatia_hnl", "title": "Croatia HNL", "api_id": 210, "aliases": ["croatia hnl", "hnl", "croatian hnl"]},
    {"key": "soccer_czech_republic_first_league", "title": "Czechia First League", "api_id": 345, "aliases": ["czechia first league", "czech first league", "fortuna liga"]},
    {"key": "soccer_denmark_superliga", "title": "Denmark Superligaen", "api_id": 119, "aliases": ["denmark superligaen", "superligaen", "danish superliga"]},
    {"key": "soccer_greece_super_league", "title": "Greece Super League 1", "api_id": 197, "aliases": ["greece super league 1", "super league", "greek super league"]},
    {"key": "soccer_hungary_nb1", "title": "Hungary NB I", "api_id": 271, "aliases": ["hungary nb i", "nb i", "hungarian nb 1"]},
    ...
    {"key": "soccer_romania_liga1", "title": "Romania Liga I", "api_id": 283, "aliases": ["romania liga i", "liga i", "romanian liga 1"]},
    {"key": "soccer_serbia_super_liga", "title": "Serbia Super Liga", "api_id": 286, "aliases": ["serbia super liga", "super liga", "serbian super liga"]},
    {"key": "soccer_slovakia_super_liga", "title": "Slovakia Super Liga", "api_id": 332, "aliases": ["slovakia super liga", "super liga slovakia"]},
    {"key": "soccer_slovenia_prva_liga", "title": "Slovenia Prva Liga", "api_id": 327, "aliases": ["slovenia prva liga", "prva liga"]},
    ...
    {"key": "soccer_switzerland_superleague", "title": "Switzerland Super League", "api_id": 207, "aliases": ["switzerland super league", "swiss super league"]},
    {"key": "soccer_turkey_super_lig", "title": "Türkiye Super Lig", "api_id": 203, "aliases": ["türkiye super lig", "super lig", "turkish super lig"]},
    {"key": "soccer_mexico_ligamx", "title": "Mexico Liga MX", "api_id": 262, "aliases": ["mexico liga mx", "liga mx", "mexican liga mx"]},
    {"key": "soccer_brazil_campeonato", "title": "Brazil Serie A", "api_id": 71, "aliases": ["brazil serie a", "serie a", "campeonato brasileiro"]},
    {"key": "soccer_argentina_primavera", "title": "Argentina Liga Profesional", "api_id": 128, "aliases": ["argentina liga profesional", "liga profesional", "argentina primera division"]},
    {"key": "soccer_colombia_primera_a", "title": "Colombia Primera A", "api_id": 239, "aliases": ["colombia primera a", "primera a", "colombian primera a"]},
    {"key": "soccer_china_super_league", "title": "China Super League", "api_id": 169, "aliases": ["china super league", "csl"]},
    {"key": "soccer_japan_j_league", "title": "Japan J-League", "api_id": 98, "aliases": ["japan j-league", "j1 league", "j-league"]},
    {"key": "soccer_south_korea_k_league_1", "title": "South Korea K League 1", "api_id": 292, "aliases": ["south korea k league 1", "k league 1"]},
    {"key": "soccer_saudi_arabia_pro_league", "title": "Saudi Arabia Pro League", "api_id": 307, "aliases": ["saudi arabia pro league", "saudi pro league"]},
    {"key": "soccer_australia_aleague", "title": "Australia A-League", "api_id": 351, "aliases": ["australia a-league", "a-league"]}
]
    ...
    try:
        ...
        if res.status_code == 200:
            for fx in res.json().get("response", []):
                ...
                h_match = home_team.lower()[:4] in h or h[:4] in home_team.lower()
                a_match = away_team.lower()[:4] in a_team or a_team[:4] in away_team.lower()
...
def execute_global_pitch_sweeps():
    ...
    all_futures_favorites = []
    leagues_with_data = 0
    total_matches_found = 0
    
    # 1. Direct Live In-Play Pipeline
                ...
                if fixtures_list:
                    ...
                    for fx in fixtures_list:
                        ...
                        if live_data.get("active"):
                            ...
                            def clean_odds_to_int(o_str):
                                return int(str(o_str).replace("+", ""))
                            
                            if is_any_valid_market_selection(l_home_odds):
                                all_discovered_favorites.append({"team": h_name, "odds": clean_odds_to_int(l_home_odds), "match": f"{h_name} vs {a_name}", "league": league_title})
                            if is_any_valid_market_selection(l_away_odds):
                                all_discovered_favorites.append({"team": a_name, "odds": clean_odds_to_int(l_away_odds), "match": f"{h_name} vs {a_name}", "league": league_title})
    ...
    # 2. Pre-Match Pipeline via The Odds API
    for sport_item in MASTER_BOOKIE_CATALOG:
        ...
        for fixture in match_data:
            ...
            time_until_kickoff = commence_dt - current_time_utc
            is_future_bracket = time_until_kickoff > datetime.timedelta(hours=48)
            
            def append_to_bracket(team_name, odds_price):
                payload = {"team": team_name, "odds": int(odds_price), "match": f"{home} vs {away}", "league": league_title, "start_time": commence_dt}
                if is_future_bracket:
                    all_futures_favorites.append(payload)
                else:
                    all_discovered_favorites.append(payload)

            if is_any_valid_market_selection(home_odds_val):
                append_to_bracket(home, home_odds_val)
            if is_any_valid_market_selection(away_odds_val):
                append_to_bracket(away, away_odds_val)

            # Send immediate 1-hour kickoff alert banner reminders
            if datetime.timedelta(minutes=50) <= time_until_kickoff <= datetime.timedelta(minutes=65):
                reminder_alert = (
                    f"⏰ **CORVETTE FUND — KICKOFF REMINDER**\n\n"
                    f"**Match Starting Soon:** {home} vs {away} starts in 1 hour ({league_title})\n"
                    f"**Current Line Consensus:** Home: {home_odds_val} | Draw: {draw_odds_val} | Away: {away_odds_val}"
                )
                send_discord_payload(reminder_alert)

            implied_p = convert_american_to_implied(home_odds_val)
            
            if not is_future_bracket and is_any_valid_market_selection(home_odds_val):
                juice_alert = (
            ...
            if not is_future_bracket and implied_p >= 0.55:
                try:
    ...
    # 08:00 AM Central Standard Time Morning Futures Dashboard Dispatch Tracker
    utc_now = datetime.datetime.now(datetime.timezone.utc)
    central_hour = (utc_now.hour - 5) % 24 
    central_minute = utc_now.minute

    if central_hour == 8 and 0 <= central_minute < 11:
        if all_futures_favorites:
            all_futures_favorites.sort(key=lambda x: x["odds"])
            futures_msg = f"🔮 **CORVETTE FUND BLUEPRINT — LONG-RANGE FUTURES DASHBOARD (2-10 DAYS OUT)**\n\n"
            for index, item in enumerate(all_futures_favorites[:20], 1):
                formatted_time = item["start_time"].strftime("%b %d @ %H:%M UTC")
                futures_msg += f"{index}. **{item['team']}** ({item['odds']}) — *{item['match']}* [{item['league']}] - Kickoff: {formatted_time}\n"
            send_discord_payload(futures_msg)
