...
if not all([DISCORD_WEBHOOK_URL, THE_ODDS_API_KEY, API_FOOTBALL_KEY]):
    ...
    for fixture in live_fixtures:
        ...
        if 30 <= live_clock <= 88:
            ...
            for bookmaker in fixture.get("bookmakers", []):
                ...
                # Target complete sportsbook matrix explicitly (Bet365, DraftKings, FanDuel, Bovada, MGM, Caesars, Fanatics, Rivers, Circa, etc.)
