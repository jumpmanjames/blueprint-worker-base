...
def monitor_live_pitches():
    """Identical 05:33:28 PM Loop Infrastructure fetching active soccer matches directly via the bulk endpoint."""
    ...
    for fixture in live_fixtures:
        ...
        # Restored baseline verification statement showing live team names on terminal logs
