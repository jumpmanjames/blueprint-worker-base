...
def monitor_live_pitches():
    ...
    # Data Age-Out Protocol: Purge active memory indexes inside the strict 60-minute post-match lifespan window
    ...
    try:
        ...
        if response.status_code == 401:
            print("❌ API Authentication Failure: Token rejected on active loop verification.")
            return
            ...
            for market in bookmaker.get("markets", []):
                if market.get("key") == "h2h":
                    for outcome in market.get("outcomes", []):
                        ...
                        # Unrestricted edge tracking math logic
